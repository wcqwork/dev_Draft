...
(function (window, $, phoenix, undefined) {
    ...
    $.extend(component_galleryCommonLink, {
        init: function (settingId, json) {
            $.fn.photoInitBank = component.component_galleryCommonLink.photoInitBank;
            var i = 0;
            ...
            $("#ffsBtn").photoInitBank(component.component_galleryCommonLink.showPhoto);
            $(".comp_image_ele").each(function(index,item){
                $(item).photoInitBank(function(photoObject){
                    
                    component.component_galleryCommonLink.showPhoto2(photoObject,item);
                });
            })
            // $(".comp_image_ele").photoInitBank(function(photoObject){
...
//             }
            ...
            // //选择图片
            // //$('.pictureIconEditChoose',editZone).photoInitBank(viewIconImg, {max: 1});
